...
#This will salt the password. And then will ask me to confirm the password when salted again.
...
print('The string to in the db is: ' + hashed_password)
old_password = input('Re-enter new password: ')
